...
// === NOUVELLES IMAGES (2→6) ===
// ⚠️ Si tes fichiers sont en .png, remplace l’extension ici.
...
// Petit composant accent image animé (drop-in)
  ...
  const slides: Slide[] = [
    {
      ...
      // ⚠️ On garde l’image du slot 1 telle quelle (logo)
    ...
    },
    {
      ...
      accent: <AccentImage src={img2} alt="Ambiance du voyage et premières inspirations" />,
    },
    {
      key: "transport",
      ...
      accent: <AccentImage src={img3} alt="Train de nuit et trajets prévus" />,
    },
    {
      key: "itinerary",
      title: "Notre itinéraire",
      body: <ItineraryInteractive />,
      accent: <AccentImage src={img4} alt="Carte stylisée de l’itinéraire" />,
    },
    {
      key: "highlights",
      title: "Moments forts — ce qu’on va vivre",
      body: <HighlightsGrid />,
      accent: <AccentImage src={img5} alt="Moments forts et activités" />,
    },
    {
      key: "cta",
      ...
      accent: <AccentImage src={img6} alt="QR / inscription / dernier appel" />,
    },
  ];
        ...
        <div className={`rounded-2xl p-6 md:p-10 ${paper}`}>
          {showInscription ? (
            ...
            <div className="grid md:grid-cols-[1fr,240px] gap-6">
              ...
              {/* Panneau accent image (2→6) ou logo sur intro */}
              <div className="hidden md:block">
                <motion.div
                  ...
                  className="rounded-xl h-full p-0 text-center text-sm bg-transparent"
                >
                  {slides[index].accent}
                </motion.div>
              </div>
